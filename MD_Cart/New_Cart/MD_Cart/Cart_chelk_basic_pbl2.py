...
if given_num!=0:
    ...
    if aim_position<320:
        cross_operation=left
        cross_time=left_time
        back_operation=right
        back_time_1=right_time
    else:
        cross_operation=right
        cross_time=right_time
        back_operation=left
        back_time_1=left_time      
    ...
    time.sleep(stop_time)
    # 第一个路口转弯------------------------------------------------------------------------------------
    send_order(cross_operation,ser)
    ...
    # '''
    # 现在开始向右转弯
    send_order(back_operation,ser)
    time.sleep(back_time_1)
    send_order('V+00',ser)
    time.sleep(stop_time)
    # '''
